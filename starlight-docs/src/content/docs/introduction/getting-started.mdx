...
import { Code, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

## Basic Setup

<Steps>
1. **Add the JavaScript SDK** to your HTML page
2. **Configure your API credentials** with meta tags
3. **Add cart functionality** using data attributes
</Steps>
...
<Aside type="caution">
Make sure to replace the placeholder values with your actual API credentials before going live. Test with your staging environment first.
</Aside>
...
<Aside type="tip">
Product profiles provide better organization and are essential for multi-currency support. They use meaningful names instead of numeric IDs.
</Aside>
