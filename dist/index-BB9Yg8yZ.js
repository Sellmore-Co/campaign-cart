...
class SentryManager {
  ...
  async initialize(config) {
    ...
    try {
      const Sentry = await import("./index-B3wS9ql5.js");
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./index-7IfSZDMl.js");
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./index-7IfSZDMl.js");
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DzwLcFPZ.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DBzeWu_g.js");
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./AttributionCollector-BNKZlCZA.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-7y9NPalX.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BIgNslgf.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BvthNHcF.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-Cn45iZXz.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-Ccj935MZ.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Defm6tSQ.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-AEv9sehY.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DYc1VfZN.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-eeEVxq08.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-oqpcRREI.js");
          return new ExpressCheckoutContainerEnhancer(element);
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-Cnv8UBs1.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-NvSmxLel.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-bmmrmxaT.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DFnMAYx8.js");
          return new RemoveItemEnhancer(element);
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-BGGIB2d1.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DU_W1vH-.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BNcWuR3e.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BflGDUWH.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Ch5vMETC.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$12.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./UtmTransfer-CXXuT7GY.js");
  ...
  static initializeErrorHandler() {
    try {
      import("./errorHandler-BOzq3rwN.js").then(({ errorHandler }) => {
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-7y9NPalX.js");
        import("./CartToggleEnhancer-BvthNHcF.js");
        import("./PackageSelectorEnhancer-Defm6tSQ.js");
        import("./ProductDisplayEnhancer-Cjx8LeAo.js");
        import("./SelectionDisplayEnhancer-BIgNslgf.js");
        import("./TimerEnhancer-AEv9sehY.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-eeEVxq08.js");
        import("./ExpressCheckoutContainerEnhancer-oqpcRREI.js");
        import("./OrderDisplayEnhancer-DIutzqXe.js");
        import("./UpsellEnhancer-BGGIB2d1.js");
        import("./AttributionCollector-BNKZlCZA.js");
        import("./CartItemListEnhancer-Cnv8UBs1.js");
        import("./QuantityControlEnhancer-bmmrmxaT.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BNcWuR3e.js");
        import("./CouponEnhancer-DU_W1vH-.js");
        import("./SimpleExitIntentEnhancer-DzwLcFPZ.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-7y9NPalX.js");
        import("./ProductDisplayEnhancer-Cjx8LeAo.js");
        import("./analytics-DDMDTJIC.js");
      }, 1e3);
    }
  });
}
