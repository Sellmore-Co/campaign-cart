<<<<<<<< HEAD:dist/chunks/ExpressCheckoutContainerEnhancer-Ch6VN3cQ.js
import { B as BaseEnhancer } from "./BaseEnhancer-BF2ZKWBi.js";
import { r as getPaymentCapabilities, f as configStore, a as useCampaignStore, u as useCartStore, s as isApplePayAvailable, v as isPayPalAvailable, w as isGooglePayAvailable, d as useCheckoutStore } from "./utils-DondkAMT.js";
...
import { G as getPaymentCapabilities, f as configStore, a as useCampaignStore, u as useCartStore, H as isApplePayAvailable, I as isPayPalAvailable, J as isGooglePayAvailable, d as useCheckoutStore, K as trackEmptyCartCheckoutAttempt, z as trackCheckoutStarted } from "./utils-BzySd55V.js";
...
>>>>>>>> origin/main:dist/chunks/ExpressCheckoutContainerEnhancer-DiJfr-GE.js
...
class ExpressCheckoutContainerEnhancer extends BaseEnhancer {
  ...
  async handleButtonClick(method, event) {
    ...
    if (cartStore.isEmpty) {
      ...
      queueMicrotask(() => {
        const country = checkoutStore.formData?.country || configStore.getState().addressConfig?.defaultCountry || "US";
        trackCheckoutStarted({
          cartValue: cartStore.total,
          itemsCount: cartStore.totalQuantity,
          detectedCountry: country,
          paymentMethod: method
          // Pass the actual method (paypal, apple_pay, google_pay)
        });
      });
    }
    try {
