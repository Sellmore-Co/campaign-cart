      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BMQfun8y.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-B0hOzJl9.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-jRqNfkwR.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CAowCMIh.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Cg0TpjE9.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BuXWStkd.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-lS6jy3B0.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BMQfun8y.js");
        import("./CartToggleEnhancer-BLVL5Il3.js");
        import("./PackageSelectorEnhancer-awZI0JRt.js");
        import("./ProductDisplayEnhancer-BCQqLR_f.js");
        import("./SelectionDisplayEnhancer-B0hOzJl9.js");
        import("./TimerEnhancer-g3k1EB3U.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CAowCMIh.js");
        import("./ExpressCheckoutContainerEnhancer-Cg0TpjE9.js");
        import("./OrderDisplayEnhancer-DSaOgV3f.js");
        import("./UpsellEnhancer-o4lsJXqU.js");
        import("./utils-CXZ9QiRP.js").then((n) => n.A);
        import("./CartItemListEnhancer-BuXWStkd.js");
