import { n as nextAnalytics, i as EcommerceEvents, b as useAttributionStore, s as getFailureUrl, v as getSuccessUrl, w as handleOrderRedirect } from "./utils-BsrzCd-y.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-BsrzCd-y.js").then((n) => n.y);
