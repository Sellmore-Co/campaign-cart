import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, t as testModeManager, C as CART_STORAGE_KEY, g as LogLevel, h as useProfileStore } from "./utils-vgQHeO41.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-vgQHeO41.js").then((n) => n.H);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-vgQHeO41.js").then((n) => n.H);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BvHLn9Ba.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DdP96SVY.js");
  ...
  getActiveProfile() {
    const { useProfileStore: useProfileStore2 } = require("@/stores/profileStore");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BvHBnjfI.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CfL9RCKM.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-M7wNSNAb.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-Db6tJKoG.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DbpgPk5X.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-ZsEd6kei.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-4ZRqooPB.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DfI5u6kG.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DlxKJ5zi.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Vdf7Dxpo.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-Bmkmc2jB.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Bm-AjUDj.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BbnCDE0E.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-Do9PV9sR.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-Dx61grXO.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Cpr8CUDi.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BF8AoTx5.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-D9e_Cp81.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BnGqKr7a.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DylG0hUd.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (!profileParam) {
      const configStore$1 = configStore.getState();
      if (configStore$1.defaultProfile) {
        try {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-vgQHeO41.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-vgQHeO41.js").then((n) => n.I).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-vgQHeO41.js").then((n) => n.J);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-vgQHeO41.js").then((n) => n.J).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BvHBnjfI.js");
        import("./CartToggleEnhancer-M7wNSNAb.js");
        import("./PackageSelectorEnhancer-ZsEd6kei.js");
        import("./ProductDisplayEnhancer-CMmNqvnn.js");
        import("./SelectionDisplayEnhancer-CfL9RCKM.js");
        import("./TimerEnhancer-4ZRqooPB.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DlxKJ5zi.js");
        import("./ExpressCheckoutContainerEnhancer-Vdf7Dxpo.js");
        import("./OrderDisplayEnhancer-DlWT4gxZ.js");
        import("./UpsellEnhancer-Dx61grXO.js");
        import("./utils-vgQHeO41.js").then((n) => n.G);
        import("./CartItemListEnhancer-Bmkmc2jB.js");
        import("./QuantityControlEnhancer-BbnCDE0E.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BF8AoTx5.js");
        import("./CouponEnhancer-Cpr8CUDi.js");
        import("./SimpleExitIntentEnhancer-BvHLn9Ba.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-BvHBnjfI.js");
        import("./ProductDisplayEnhancer-CMmNqvnn.js");
        import("./utils-vgQHeO41.js").then((n) => n.K);
      }, 1e3);
    }
  });
}
