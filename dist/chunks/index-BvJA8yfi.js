...
import { ApiClient } from "./api-j9fTHBUy.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-BMhjDSF3.js").then((n) => n.a0);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-BMhjDSF3.js").then((n) => n.a0);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DUkjtJG3.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DsHIfhF9.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BE1v89s4.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-VGZ1cx1I.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CQIcjfrJ.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-z2c4mrLF.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-D0NBLGaA.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-C6Uo2Syx.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-PX3rQkgQ.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DFA2Vnhq.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DyN6z1Wl.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-D1kTyokH.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-C5GH5eHQ.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Bx29aQTc.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-hyl1rG4k.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BjJThO0k.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-C7iyIBRS.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BXCthxzj.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-D1P2lkF4.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Cjhao03O.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BIKIInva.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-KB2Vy4V8.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-BMhjDSF3.js").then((n) => n.Z);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-BMhjDSF3.js").then((n) => n.Z);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BMhjDSF3.js").then((n) => n.a1);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BMhjDSF3.js").then((n) => n.a2).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-BMhjDSF3.js").then((n) => n.a3);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-BMhjDSF3.js").then((n) => n.a3).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BE1v89s4.js");
        import("./CartToggleEnhancer-CQIcjfrJ.js");
        import("./PackageSelectorEnhancer-C6Uo2Syx.js");
        import("./ProductDisplayEnhancer-CxbdcmT7.js");
        import("./SelectionDisplayEnhancer-VGZ1cx1I.js");
        import("./TimerEnhancer-PX3rQkgQ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DyN6z1Wl.js");
        import("./ExpressCheckoutContainerEnhancer-D1kTyokH.js");
        import("./OrderDisplayEnhancer-F2f0BULE.js");
        import("./UpsellEnhancer-C7iyIBRS.js");
        import("./utils-BMhjDSF3.js").then((n) => n.$);
        import("./CartItemListEnhancer-C5GH5eHQ.js");
        import("./QuantityControlEnhancer-hyl1rG4k.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-D1P2lkF4.js");
        import("./CouponEnhancer-BXCthxzj.js");
        import("./SimpleExitIntentEnhancer-DUkjtJG3.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-BE1v89s4.js");
        import("./ProductDisplayEnhancer-CxbdcmT7.js");
        import("./utils-BMhjDSF3.js").then((n) => n.a4);
      }, 1e3);
    }
  });
}
