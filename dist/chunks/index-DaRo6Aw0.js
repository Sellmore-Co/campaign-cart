<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, C as CountryService, t as testModeManager, g as CART_STORAGE_KEY, h as LogLevel } from "./utils-DondkAMT.js";
import { ApiClient } from "./api-D4lLxLPI.js";
========
import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, g as trackPageView, h as trackSDKInitialized, i as trackSDKInitializationFailed, j as trackCampaignLoaded, k as testModeManager, C as CART_STORAGE_KEY, l as trackCartLoaded, m as LogLevel } from "./utils-BzySd55V.js";
import { ApiClient } from "./api-CJA3TCCv.js";
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        const { nextAnalytics } = await import("./utils-DondkAMT.js").then((n) => n.J);
========
        const { nextAnalytics } = await import("./utils-BzySd55V.js").then((n) => n.V);
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        const { nextAnalytics, EcommerceEvents } = await import("./utils-DondkAMT.js").then((n) => n.J);
========
        const { nextAnalytics, EcommerceEvents } = await import("./utils-BzySd55V.js").then((n) => n.V);
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DW0TnhR7.js");
========
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Bov5wMVI.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Cw7fbVeK.js");
========
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-zUxyOO-F.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BEqqlL_0.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-C0e0t3b9.js");
...
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
        ...
        case "toggle":
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BRz2cSVz.js");
========
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-D29sLpxf.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
        ...
        case "action":
          ...
          switch (action) {
            case "add-to-cart":
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-DYf6GyPb.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-JJdBrSiH.js");
========
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-C-NwreO2.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-BqCB8mqz.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
        ...
        case "selector":
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DAWdZSO-.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DLEhywYz.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DGFix0gj.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-B6D_vJ55.js");
========
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Di5QSmGF.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Ch6VN3cQ.js");
========
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DiJfr-GE.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
        ...
        case "cart-items":
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-C4qalMlS.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CD0dbY9n.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BqkCRdlF.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DfaIWYZP.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-DS_CTNAp.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BmzCvjA-.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-D01cYjeb.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DyzEakV9.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-VZpAvacc.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-B-Qv0LJ8.js");
========
        ...
        case "quantity":
          ...
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BntD_Jzu.js");
          return new RemoveItemEnhancer(element);
        // 'order' case removed - order display now handled via data-next-display="order.xxx" pattern
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-Daw2Opxj.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-CTiqWv5t.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DdakRVxr.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-D-yRwSfG.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Djwswn9_.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-vHoR52zJ.js");
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        const { UtmTransfer } = await import("./utils-DondkAMT.js").then((n) => n.U);
========
        const { UtmTransfer } = await import("./utils-BzySd55V.js").then((n) => n.W);
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
  ...
  static initializeErrorHandler() {
    try {
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
      import("./utils-DondkAMT.js").then((n) => n.K).then(({ errorHandler }) => {
========
      import("./utils-BzySd55V.js").then((n) => n.X).then(({ errorHandler }) => {
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
      const { debugOverlay } = await import("./utils-DondkAMT.js").then((n) => n.M);
========
      const { debugOverlay } = await import("./utils-BzySd55V.js").then((n) => n.Y);
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        overlay: () => import("./utils-DondkAMT.js").then((n) => n.M).then((m) => m.debugOverlay),
========
        overlay: () => import("./utils-BzySd55V.js").then((n) => n.Y).then((m) => m.debugOverlay),
>>>>>>>> origin/main:dist/chunks/index-DaRo6Aw0.js
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
<<<<<<<< HEAD:dist/chunks/index-CNGWMEZS.js
        import("./CartDisplayEnhancer-BEqqlL_0.js");
        import("./CartToggleEnhancer-BRz2cSVz.js");
        import("./PackageSelectorEnhancer-DAWdZSO-.js");
        import("./ProductDisplayEnhancer-Dw4GsJt1.js");
        import("./SelectionDisplayEnhancer-C0e0t3b9.js");
        import("./TimerEnhancer-DLEhywYz.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-B6D_vJ55.js");
        import("./ExpressCheckoutContainerEnhancer-Ch6VN3cQ.js");
        import("./OrderDisplayEnhancer-CoS0Exiz.js");
        import("./UpsellEnhancer-DS_CTNAp.js");
        import("./utils-DondkAMT.js").then((n) => n.I);
        import("./CartItemListEnhancer-C4qalMlS.js");
        import("./QuantityControlEnhancer-BqkCRdlF.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-D01cYjeb.js");
        import("./CouponEnhancer-BmzCvjA-.js");
        import("./SimpleExitIntentEnhancer-DW0TnhR7.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-BEqqlL_0.js");
        import("./ProductDisplayEnhancer-Dw4GsJt1.js");
        import("./utils-DondkAMT.js").then((n) => n.N);
========
      ...
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DdakRVxr.js");
        import("./CouponEnhancer-CTiqWv5t.js");
        import("./SimpleExitIntentEnhancer-Bov5wMVI.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-CkPEDilI.js");
