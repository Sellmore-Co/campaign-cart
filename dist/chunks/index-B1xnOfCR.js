import { c as createLogger, L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useCheckoutStore, d as configStore, t as testModeManager, e as LogLevel } from "./utils-DXW2sLDJ.js";
import { c as create, d as devtools, p as persist } from "./vendor-B2NPMtAQ.js";
import { ApiClient } from "./api-BmhZBWdi.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-DXW2sLDJ.js").then((n) => n.m);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-DXW2sLDJ.js").then((n) => n.m);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CwnKK1ji.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DHgznwO5.js");
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-DXW2sLDJ.js").then((n) => n.A);
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DJBgUtat.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DAZo3Vmd.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-Cn-ha1mC.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-TCm_hJXz.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DmSNRJR1.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-CVr6vQly.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BPjFFVpM.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DyyXe6xb.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-ClMnSvvK.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-B5ROZKVI.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DmeJV5BO.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CgXVznCd.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-DOzsZpuR.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BIIyIz1B.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-B9vXZKwv.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BRExPwnA.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-C_SyYyYL.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-g4EcULRp.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-D_WW7gPX.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BCT5-jau.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DXW2sLDJ.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DXW2sLDJ.js").then((n) => n.n).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-DXW2sLDJ.js").then((n) => n.o);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-DXW2sLDJ.js").then((n) => n.o).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DJBgUtat.js");
        import("./CartToggleEnhancer-Cn-ha1mC.js");
        import("./PackageSelectorEnhancer-CVr6vQly.js");
        import("./ProductDisplayEnhancer-CqTMlGRx.js");
        import("./SelectionDisplayEnhancer-DAZo3Vmd.js");
        import("./TimerEnhancer-BPjFFVpM.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-ClMnSvvK.js");
        import("./ExpressCheckoutContainerEnhancer-B5ROZKVI.js");
        import("./OrderDisplayEnhancer-DVBFQZir.js");
        import("./UpsellEnhancer-B9vXZKwv.js");
        import("./utils-DXW2sLDJ.js").then((n) => n.A);
        import("./CartItemListEnhancer-DmeJV5BO.js");
        import("./QuantityControlEnhancer-DOzsZpuR.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-C_SyYyYL.js");
        import("./CouponEnhancer-BRExPwnA.js");
        import("./SimpleExitIntentEnhancer-CwnKK1ji.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-DJBgUtat.js");
        import("./ProductDisplayEnhancer-CqTMlGRx.js");
        import("./utils-DXW2sLDJ.js").then((n) => n.q);
      }, 1e3);
    }
  });
}
