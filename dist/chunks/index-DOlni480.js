import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, t as testModeManager, C as CART_STORAGE_KEY, g as LogLevel } from "./utils-i-zmobgJ.js";
import { ApiClient } from "./api-wdEtYTpc.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-i-zmobgJ.js").then((n) => n.B);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-i-zmobgJ.js").then((n) => n.B);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-tCz4ib_R.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-33mumsH7.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BO5d51kM.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BSVX6k8s.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-lY2keydm.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BotLeG6O.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DiV075Oz.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-D5qcnfEr.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-C0M8A1aW.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DgJpo9cI.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Cz9NVZ0g.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-B9-wUBgo.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-6SrixB5t.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CA8NOxaI.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-5ZjzXQLC.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DGq2Lf2c.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CMEtqw02.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-vTLpb2hX.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-B1vJQ5wy.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-jWC19ney.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BRF-XKa-.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-Bma27OJd.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-i-zmobgJ.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-i-zmobgJ.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-i-zmobgJ.js").then((n) => n.H);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-i-zmobgJ.js").then((n) => n.H).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BO5d51kM.js");
        import("./CartToggleEnhancer-lY2keydm.js");
        import("./PackageSelectorEnhancer-D5qcnfEr.js");
        import("./ProductDisplayEnhancer-CzXx-zPr.js");
        import("./SelectionDisplayEnhancer-BSVX6k8s.js");
        import("./TimerEnhancer-C0M8A1aW.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Cz9NVZ0g.js");
        import("./ExpressCheckoutContainerEnhancer-B9-wUBgo.js");
        import("./OrderDisplayEnhancer-BWvAPuJJ.js");
        import("./UpsellEnhancer-CMEtqw02.js");
        import("./utils-i-zmobgJ.js").then((n) => n.A);
        import("./CartItemListEnhancer-6SrixB5t.js");
        import("./QuantityControlEnhancer-5ZjzXQLC.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-B1vJQ5wy.js");
        import("./CouponEnhancer-vTLpb2hX.js");
        import("./SimpleExitIntentEnhancer-tCz4ib_R.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-BO5d51kM.js");
        import("./ProductDisplayEnhancer-CzXx-zPr.js");
        import("./utils-i-zmobgJ.js").then((n) => n.I);
      }, 1e3);
    }
  });
}
