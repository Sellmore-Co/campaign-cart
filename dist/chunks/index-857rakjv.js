      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-_-qA2hbv.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CmDSC0w5.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-MnZCV9tH.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-ClUbaVS-.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Dd_LGpId.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BG2QDr3k.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-Dy4qk2Sm.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-BWINR5Yr.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-m2Y0om_6.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-_-qA2hbv.js");
        import("./CartToggleEnhancer-Cn-ha1mC.js");
        import("./PackageSelectorEnhancer-CVr6vQly.js");
        import("./ProductDisplayEnhancer-DgRhHJUF.js");
        import("./SelectionDisplayEnhancer-CmDSC0w5.js");
        import("./TimerEnhancer-BPjFFVpM.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Dd_LGpId.js");
        import("./ExpressCheckoutContainerEnhancer-BG2QDr3k.js");
        import("./OrderDisplayEnhancer-DoHtIM71.js");
        import("./UpsellEnhancer-m2Y0om_6.js");
        import("./utils-DXW2sLDJ.js").then((n) => n.A);
        import("./CartItemListEnhancer-Dy4qk2Sm.js");
