import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, g as useProfileStore, c as createLogger, t as testModeManager, C as CART_STORAGE_KEY, h as LogLevel } from "./utils-C0fPUD1W.js";
import { ApiClient } from "./api-BEluNReW.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-C0fPUD1W.js").then((n) => n.H);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-C0fPUD1W.js").then((n) => n.H);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-tVp6mAtC.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-xtbYdLkR.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DGEUowBa.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-D67V025x.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-C2GcaeD8.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-VDarj7mb.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DhAbziR-.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DGTXpE1O.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-C7qyDHMZ.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-jMHRyeQO.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-rCtJ6OUV.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BRjuHqSX.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BbhTA37S.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-lwLKPTdS.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BcNNPde9.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-Dg7Pdwke.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-GEwnCBM3.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Cns8JiLT.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-4o5XlV-Y.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CPwIIbmj.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BHR7wlDQ.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-Dl7q5ynq.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C0fPUD1W.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C0fPUD1W.js").then((n) => n.I).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-C0fPUD1W.js").then((n) => n.J);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-C0fPUD1W.js").then((n) => n.J).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DGEUowBa.js");
        import("./CartToggleEnhancer-C2GcaeD8.js");
        import("./PackageSelectorEnhancer-DGTXpE1O.js");
        import("./ProductDisplayEnhancer-CMqO-xrp.js");
        import("./SelectionDisplayEnhancer-D67V025x.js");
        import("./TimerEnhancer-C7qyDHMZ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-rCtJ6OUV.js");
        import("./ExpressCheckoutContainerEnhancer-BRjuHqSX.js");
        import("./OrderDisplayEnhancer-_XnVnyFq.js");
        import("./UpsellEnhancer-GEwnCBM3.js");
        import("./utils-C0fPUD1W.js").then((n) => n.G);
        import("./CartItemListEnhancer-BbhTA37S.js");
        import("./QuantityControlEnhancer-BcNNPde9.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-4o5XlV-Y.js");
        import("./CouponEnhancer-Cns8JiLT.js");
        import("./SimpleExitIntentEnhancer-tVp6mAtC.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-DGEUowBa.js");
        import("./ProductDisplayEnhancer-CMqO-xrp.js");
        import("./utils-C0fPUD1W.js").then((n) => n.K);
      }, 1e3);
    }
  });
}
