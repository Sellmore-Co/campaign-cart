<<<<<<<< HEAD:dist/chunks/OrderManager-DzRw68fq.js
import { n as nextAnalytics, m as EcommerceEvents, a as useCampaignStore, f as configStore, b as useAttributionStore, x as getFailureUrl, y as getSuccessUrl, u as useCartStore, d as useCheckoutStore, z as handleOrderRedirect } from "./utils-DondkAMT.js";
========
import { p as nextAnalytics, q as EcommerceEvents, b as useAttributionStore, M as getFailureUrl, N as getSuccessUrl, O as handleOrderRedirect } from "./utils-BzySd55V.js";
>>>>>>>> origin/main:dist/chunks/OrderManager-Bgv7Sast.js
...
<<<<<<<< HEAD:dist/chunks/OrderManager-DzRw68fq.js
      const { useCartStore: useCartStore2 } = await import("./utils-DondkAMT.js").then((n) => n.H);
      const cartStore = useCartStore2.getState();
========
      const { useCartStore } = await import("./utils-BzySd55V.js").then((n) => n.S);
      const cartStore = useCartStore.getState();
>>>>>>>> origin/main:dist/chunks/OrderManager-Bgv7Sast.js
