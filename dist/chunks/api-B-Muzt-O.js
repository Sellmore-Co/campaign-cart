import { c as createLogger, t as trackAPICall } from "./utils-BiJ8-_Kg.js";
class ApiClient {
  constructor(apiKey, useCdnCache = false) {
  ...
  async getCampaigns(currency) {
    if (this.useCdnCache) {
      ...
      this.logger.debug("Using CDN cache for campaign fetch");
