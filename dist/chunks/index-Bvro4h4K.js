...
import { ApiClient } from "./api-B-Muzt-O.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-BiJ8-_Kg.js").then((n) => n.a0);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-BiJ8-_Kg.js").then((n) => n.a0);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-h5GCU8Dd.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Bt2ccIBC.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-C45Wfp4a.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-sBwkZ_3A.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CrQvItdv.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-cElUe44O.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-D-w06Oi0.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Dw2IpoR5.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BqyVDAxa.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DoKhqMrb.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BeZew36J.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-C-nVHB9k.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Bdnhx5cB.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DvF9S70E.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-D_DPErWU.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BoH9IyW3.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-CbFKzM30.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-DyahUCWd.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BLyezQGY.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DW3rT_dM.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CDCddD88.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BjuzeF5H.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-idHIY1wB.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-BiJ8-_Kg.js").then((n) => n.Z);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-BiJ8-_Kg.js").then((n) => n.Z);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BiJ8-_Kg.js").then((n) => n.a1);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BiJ8-_Kg.js").then((n) => n.a2).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-BiJ8-_Kg.js").then((n) => n.a3);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-BiJ8-_Kg.js").then((n) => n.a3).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-C45Wfp4a.js");
        import("./CartToggleEnhancer-CrQvItdv.js");
        import("./PackageSelectorEnhancer-Dw2IpoR5.js");
        import("./ProductDisplayEnhancer-By2fcFhW.js");
        import("./SelectionDisplayEnhancer-sBwkZ_3A.js");
        import("./TimerEnhancer-BqyVDAxa.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BeZew36J.js");
        import("./ExpressCheckoutContainerEnhancer-Bdnhx5cB.js");
        import("./OrderDisplayEnhancer-DRnf_SeD.js");
        import("./UpsellEnhancer-DyahUCWd.js");
        import("./utils-BiJ8-_Kg.js").then((n) => n.$);
        import("./CartItemListEnhancer-DvF9S70E.js");
        import("./QuantityControlEnhancer-BoH9IyW3.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DW3rT_dM.js");
        import("./CouponEnhancer-BLyezQGY.js");
        import("./SimpleExitIntentEnhancer-h5GCU8Dd.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-C45Wfp4a.js");
        import("./ProductDisplayEnhancer-By2fcFhW.js");
        import("./utils-BiJ8-_Kg.js").then((n) => n.a4);
      }, 1e3);
    }
  });
}
