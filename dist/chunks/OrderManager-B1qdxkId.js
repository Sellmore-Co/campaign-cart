import { w as nextAnalytics, x as EcommerceEvents, a as useCampaignStore, f as configStore, b as useAttributionStore, R as getFailureUrl, S as getSuccessUrl, u as useCartStore, d as useCheckoutStore, T as handleOrderRedirect } from "./utils-DSTJmtJJ.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore: useCartStore2 } = await import("./utils-DSTJmtJJ.js").then((n) => n._);
