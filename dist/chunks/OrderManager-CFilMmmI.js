import { s as nextAnalytics, v as EcommerceEvents, a as useCampaignStore, f as configStore, b as useAttributionStore, O as getFailureUrl, Q as getSuccessUrl, u as useCartStore, d as useCheckoutStore, R as handleOrderRedirect } from "./utils-D3MhrmeJ.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore: useCartStore2 } = await import("./utils-D3MhrmeJ.js").then((n) => n.X);
