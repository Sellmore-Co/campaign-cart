import { c as createLogger, L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useCheckoutStore, d as configStore, t as testModeManager, e as LogLevel } from "./utils-DjferbrJ.js";
import { c as create, d as devtools, p as persist } from "./vendor-B2NPMtAQ.js";
import { ApiClient } from "./api-KriitwVe.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-DjferbrJ.js").then((n) => n.m);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-DjferbrJ.js").then((n) => n.m);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-EsesWqUQ.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-qOUtVsrB.js");
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-DjferbrJ.js").then((n) => n.A);
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BF77f_vO.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CLFmMKds.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CUm93sNj.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-Bg42YXK7.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DRK2cysO.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-D8rriWS_.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BafaW5yZ.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-SOapEbps.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CzdkItFV.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer--Rwrhnq7.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BpwSHXda.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-B3k7-7i2.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-C24CsMCc.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BqBTt694.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-BFsS6dk5.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Bya44VDY.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BQ1A50vG.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BAz_VUFC.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CGMxa56Z.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CnFfZ8p1.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DjferbrJ.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DjferbrJ.js").then((n) => n.n).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-DjferbrJ.js").then((n) => n.o);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-DjferbrJ.js").then((n) => n.o).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BF77f_vO.js");
        import("./CartToggleEnhancer-CUm93sNj.js");
        import("./PackageSelectorEnhancer-D8rriWS_.js");
        import("./ProductDisplayEnhancer-yFwA0cOd.js");
        import("./SelectionDisplayEnhancer-CLFmMKds.js");
        import("./TimerEnhancer-BafaW5yZ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CzdkItFV.js");
        import("./ExpressCheckoutContainerEnhancer--Rwrhnq7.js");
        import("./OrderDisplayEnhancer-CmW7rIbF.js");
        import("./UpsellEnhancer-BFsS6dk5.js");
        import("./utils-DjferbrJ.js").then((n) => n.A);
        import("./CartItemListEnhancer-BpwSHXda.js");
        import("./QuantityControlEnhancer-C24CsMCc.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BQ1A50vG.js");
        import("./CouponEnhancer-Bya44VDY.js");
        import("./SimpleExitIntentEnhancer-EsesWqUQ.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-BF77f_vO.js");
        import("./ProductDisplayEnhancer-yFwA0cOd.js");
        import("./utils-DjferbrJ.js").then((n) => n.q);
      }, 1e3);
    }
  });
}
