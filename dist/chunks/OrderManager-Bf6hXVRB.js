import { n as nextAnalytics, m as EcommerceEvents, a as useCampaignStore, f as configStore, b as useAttributionStore, x as getFailureUrl, y as getSuccessUrl, u as useCartStore, d as useCheckoutStore, z as handleOrderRedirect } from "./utils-CBsAJYAz.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore: useCartStore2 } = await import("./utils-CBsAJYAz.js").then((n) => n.H);
