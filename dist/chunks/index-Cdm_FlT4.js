import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, g as trackPageView, h as trackSDKInitialized, i as trackSDKInitializationFailed, C as CountryService, j as trackCampaignLoaded, k as testModeManager, l as CART_STORAGE_KEY, m as trackCartLoaded, n as LogLevel } from "./utils-D3MhrmeJ.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-D3MhrmeJ.js").then((n) => n.Z);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-D3MhrmeJ.js").then((n) => n.Z);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Cqg-bVg2.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Bzn3pvF9.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BBwY-ixP.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-6OMr-CRa.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BSA67CYI.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BIdfo6Qu.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-Csb9ps3L.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-C4uVCw-T.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-w2G_CMta.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-COf4tGXE.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-EDvpc5wK.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-cHmKPRzq.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BvDp1E2M.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DQ2aJUHE.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-Cr-hQKn3.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-_zxCAWl6.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CPXKihXc.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-31RNqS4a.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DgmSkHP4.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DII3ek-q.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BRsZFJFL.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-oW4OtL7o.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-D3MhrmeJ.js").then((n) => n._);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-D3MhrmeJ.js").then((n) => n.$).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-D3MhrmeJ.js").then((n) => n.a0);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-D3MhrmeJ.js").then((n) => n.a0).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BBwY-ixP.js");
        import("./CartToggleEnhancer-BSA67CYI.js");
        import("./PackageSelectorEnhancer-C4uVCw-T.js");
        import("./ProductDisplayEnhancer-CsjVSE-l.js");
        import("./SelectionDisplayEnhancer-6OMr-CRa.js");
        import("./TimerEnhancer-w2G_CMta.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-EDvpc5wK.js");
        import("./ExpressCheckoutContainerEnhancer-cHmKPRzq.js");
        import("./OrderDisplayEnhancer-FaCvmsII.js");
        import("./UpsellEnhancer-CPXKihXc.js");
        import("./utils-D3MhrmeJ.js").then((n) => n.Y);
        import("./CartItemListEnhancer-BvDp1E2M.js");
        import("./QuantityControlEnhancer-Cr-hQKn3.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DgmSkHP4.js");
        import("./CouponEnhancer-31RNqS4a.js");
        import("./SimpleExitIntentEnhancer-Cqg-bVg2.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-BBwY-ixP.js");
        import("./ProductDisplayEnhancer-CsjVSE-l.js");
        import("./utils-D3MhrmeJ.js").then((n) => n.a1);
      }, 1e3);
    }
  });
}
