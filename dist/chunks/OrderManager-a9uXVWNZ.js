import { n as nextAnalytics, m as EcommerceEvents, a as useCampaignStore, f as configStore, b as useAttributionStore, x as getFailureUrl, y as getSuccessUrl, u as useCartStore, d as useCheckoutStore, z as handleOrderRedirect } from "./utils-D8OWy5yH.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore: useCartStore2 } = await import("./utils-D8OWy5yH.js").then((n) => n.I);
