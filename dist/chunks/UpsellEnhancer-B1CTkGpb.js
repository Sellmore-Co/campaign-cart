...
import { a as useOrderStore } from "./index-h_mHFKUL.js";
import { d as configStore, a as useCampaignStore, p as preserveQueryParams } from "./utils-B9l4NwAb.js";
...
const _UpsellEnhancer = class _UpsellEnhancer extends BaseEnhancer {
  ...
  updateQuantityDisplay() {
    ...
    if (display) {
      const displaySelectorId = display.getAttribute("data-next-quantity-selector-id") || this.currentQuantitySelectorId || this.selectorId;
