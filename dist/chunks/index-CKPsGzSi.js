      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DTgJ1q_I.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-xve-3xyM.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DyFuzJdR.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Baf6DYg4.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CSwDP7_K.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DGMtXQAm.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-B9CeA2HO.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CALmLkP7.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-ChlRrrm3.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DTgJ1q_I.js");
        import("./CartToggleEnhancer-CZ8WdBwn.js");
        import("./PackageSelectorEnhancer-BzCT514W.js");
        import("./ProductDisplayEnhancer-CZHieWEI.js");
        import("./SelectionDisplayEnhancer-xve-3xyM.js");
        import("./TimerEnhancer-DBkj-2uv.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CSwDP7_K.js");
        import("./ExpressCheckoutContainerEnhancer-DGMtXQAm.js");
        import("./OrderDisplayEnhancer-CAYRCuME.js");
        import("./UpsellEnhancer-ChlRrrm3.js");
        import("./utils-DuJ9n22D.js").then((n) => n.A);
        import("./CartItemListEnhancer-B9CeA2HO.js");
