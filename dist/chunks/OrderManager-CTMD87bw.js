import { n as nextAnalytics, i as EcommerceEvents, b as useAttributionStore, m as getFailureUrl, o as getSuccessUrl, p as handleOrderRedirect } from "./utils-B07ZfNY3.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-B07ZfNY3.js").then((n) => n.r);
