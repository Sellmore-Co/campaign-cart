...
import { ApiClient } from "./api-x6Pmmo5e.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-zDRSnh-1.js").then((n) => n.a0);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-zDRSnh-1.js").then((n) => n.a0);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DMzizx7D.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-PuzHVOUr.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CMfpVbyT.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-C-tzyw6U.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-XEqeGObi.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer--UyRGad7.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-46voLDIC.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-hTL8ACIH.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-D57E_fyZ.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-D0AVcPrW.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CuISZp_M.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CIJ8jc4V.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BDmytALk.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DV66Y0yS.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-C3r1bkar.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-Ta-7_B8_.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CdhUmMR-.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Br4KJu-O.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DXWQDQ_c.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DfUlZm4i.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BNN9bQQg.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-mM8LTvem.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-zDRSnh-1.js").then((n) => n.Z);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-zDRSnh-1.js").then((n) => n.Z);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-zDRSnh-1.js").then((n) => n.a1);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-zDRSnh-1.js").then((n) => n.a2).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-zDRSnh-1.js").then((n) => n.a3);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-zDRSnh-1.js").then((n) => n.a3).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CMfpVbyT.js");
        import("./CartToggleEnhancer-XEqeGObi.js");
        import("./PackageSelectorEnhancer-hTL8ACIH.js");
        import("./ProductDisplayEnhancer-cQTkFxMS.js");
        import("./SelectionDisplayEnhancer-C-tzyw6U.js");
        import("./TimerEnhancer-D57E_fyZ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CuISZp_M.js");
        import("./ExpressCheckoutContainerEnhancer-CIJ8jc4V.js");
        import("./OrderDisplayEnhancer-DlqETSk_.js");
        import("./UpsellEnhancer-CdhUmMR-.js");
        import("./utils-zDRSnh-1.js").then((n) => n.$);
        import("./CartItemListEnhancer-BDmytALk.js");
        import("./QuantityControlEnhancer-C3r1bkar.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DXWQDQ_c.js");
        import("./CouponEnhancer-Br4KJu-O.js");
        import("./SimpleExitIntentEnhancer-DMzizx7D.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-CMfpVbyT.js");
        import("./ProductDisplayEnhancer-cQTkFxMS.js");
        import("./utils-zDRSnh-1.js").then((n) => n.a4);
      }, 1e3);
    }
  });
}
