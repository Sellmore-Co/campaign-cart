import { n as nextAnalytics, i as EcommerceEvents, b as useAttributionStore, m as getFailureUrl, o as getSuccessUrl, p as handleOrderRedirect } from "./utils-C6G5tVza.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-C6G5tVza.js").then((n) => n.r);
