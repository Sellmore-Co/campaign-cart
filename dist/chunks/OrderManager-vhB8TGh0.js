import { n as nextAnalytics, l as EcommerceEvents, b as useAttributionStore, x as getFailureUrl, y as getSuccessUrl, z as handleOrderRedirect } from "./utils-C0fPUD1W.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-C0fPUD1W.js").then((n) => n.B);
