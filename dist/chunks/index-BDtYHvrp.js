      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-qU72E-dD.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-YL0qxXRO.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-kgF3pSsc.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer--TnsHJkY.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DtOOobsd.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CYxae7r4.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CrPtAfqL.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CyqeESTX.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-D_8lE2kw.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-qU72E-dD.js");
        import("./CartToggleEnhancer-bmZVexNZ.js");
        import("./PackageSelectorEnhancer-BWqhvc6Z.js");
        import("./ProductDisplayEnhancer-CeQIufBr.js");
        import("./SelectionDisplayEnhancer-YL0qxXRO.js");
        import("./TimerEnhancer-CTstG9Jl.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DtOOobsd.js");
        import("./ExpressCheckoutContainerEnhancer-CYxae7r4.js");
        import("./OrderDisplayEnhancer-BOBPMNnl.js");
        import("./UpsellEnhancer-D_8lE2kw.js");
        import("./utils-DLgCaKeh.js").then((n) => n.A);
        import("./CartItemListEnhancer-CrPtAfqL.js");
