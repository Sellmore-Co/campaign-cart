import { c as createLogger, L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useCheckoutStore, d as configStore, t as testModeManager, e as LogLevel } from "./utils-DBcBpo1g.js";
import { c as create, d as devtools, p as persist } from "./vendor-B2NPMtAQ.js";
import { ApiClient } from "./api-BxNJMq9i.js";
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-DBcBpo1g.js").then((n) => n.A);
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-DBcBpo1g.js").then((n) => n.m);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-DBcBpo1g.js").then((n) => n.m);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BpN9TQzK.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CJQNFSpb.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CMVm1Nl9.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-6x9rRNJQ.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-DvhD6Akm.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BkyHYXa5.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-DJzvf1Za.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-B-XDsNLz.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-jgABMaL2.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DmYcyXOt.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Bz5KGaXN.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-z33jWv_n.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-vza4I27Y.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-D8uUV9gf.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-DKOV4hY3.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-3FQDxRC8.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-C1YMP_F9.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BCWj-j-A.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CfqtI5eU.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-QmnCGCiO.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-i5XOYlGz.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-_pB40NLL.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DBcBpo1g.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DBcBpo1g.js").then((n) => n.n).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-DBcBpo1g.js").then((n) => n.o);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-DBcBpo1g.js").then((n) => n.o).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CMVm1Nl9.js");
        import("./CartToggleEnhancer-DvhD6Akm.js");
        import("./PackageSelectorEnhancer-B-XDsNLz.js");
        import("./ProductDisplayEnhancer-C4r_b_ht.js");
        import("./SelectionDisplayEnhancer-6x9rRNJQ.js");
        import("./TimerEnhancer-jgABMaL2.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Bz5KGaXN.js");
        import("./ExpressCheckoutContainerEnhancer-z33jWv_n.js");
        import("./OrderDisplayEnhancer-GQ98uoCd.js");
        import("./UpsellEnhancer-C1YMP_F9.js");
        import("./utils-DBcBpo1g.js").then((n) => n.A);
        import("./CartItemListEnhancer-vza4I27Y.js");
        import("./QuantityControlEnhancer-DKOV4hY3.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CfqtI5eU.js");
        import("./CouponEnhancer-BCWj-j-A.js");
        import("./SimpleExitIntentEnhancer-BpN9TQzK.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-CMVm1Nl9.js");
        import("./ProductDisplayEnhancer-C4r_b_ht.js");
        import("./utils-DBcBpo1g.js").then((n) => n.q);
      }, 1e3);
    }
  });
}
