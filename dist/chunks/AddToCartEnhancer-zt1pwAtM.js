import { B as BaseActionEnhancer } from "./BaseActionEnhancer-DN5u05Dt.js";
import { u as useCartStore, U as preserveQueryParams } from "./utils-BvMFuFWj.js";
class AddToCartEnhancer extends BaseActionEnhancer {
  ...
  async handleClick(event) {
    ...
    if (profileOverride) {
      const { ProfileManager } = await import("./index-D1kBALZN.js").then((n) => n.c);
