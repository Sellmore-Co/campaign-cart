import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, C as CountryService, t as testModeManager, g as CART_STORAGE_KEY, h as LogLevel } from "./utils-C9a5e9jY.js";
import { ApiClient } from "./api-BRRVIZHQ.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-C9a5e9jY.js").then((n) => n.K);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-C9a5e9jY.js").then((n) => n.K);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-C09Iaqjy.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CzkvfX6k.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CzgxhZ9l.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-D6cztGjQ.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-DPJh0fzZ.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-D1E60CGi.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CTDiYPKL.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-CHnNha-C.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-C6VsN1VX.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DV1uFv_Q.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DIQ0OIwN.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DHoCChhg.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CONjrw27.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-SUIp7siO.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-CovM4UzG.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-SjeAODC0.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-Dd2RaVNm.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DG0XFO-8.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DcM5zvSF.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CmfYkBpb.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BVp7ekHw.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CTDen74-.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C9a5e9jY.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C9a5e9jY.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-C9a5e9jY.js").then((n) => n.N);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-C9a5e9jY.js").then((n) => n.N).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CzgxhZ9l.js");
        import("./CartToggleEnhancer-DPJh0fzZ.js");
        import("./PackageSelectorEnhancer-CHnNha-C.js");
        import("./ProductDisplayEnhancer-c5V4Djos.js");
        import("./SelectionDisplayEnhancer-D6cztGjQ.js");
        import("./TimerEnhancer-C6VsN1VX.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DIQ0OIwN.js");
        import("./ExpressCheckoutContainerEnhancer-DHoCChhg.js");
        import("./OrderDisplayEnhancer-B9-wXhlA.js");
        import("./UpsellEnhancer-Dd2RaVNm.js");
        import("./utils-C9a5e9jY.js").then((n) => n.J);
        import("./CartItemListEnhancer-CONjrw27.js");
        import("./QuantityControlEnhancer-CovM4UzG.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DcM5zvSF.js");
        import("./CouponEnhancer-DG0XFO-8.js");
        import("./SimpleExitIntentEnhancer-C09Iaqjy.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-CzgxhZ9l.js");
        import("./ProductDisplayEnhancer-c5V4Djos.js");
        import("./utils-C9a5e9jY.js").then((n) => n.O);
      }, 1e3);
    }
  });
}
