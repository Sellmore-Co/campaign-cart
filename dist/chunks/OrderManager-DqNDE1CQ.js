import { p as nextAnalytics, q as EcommerceEvents, b as useAttributionStore, M as getFailureUrl, N as getSuccessUrl, O as handleOrderRedirect } from "./utils-B7cp-Wqf.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-B7cp-Wqf.js").then((n) => n.S);
