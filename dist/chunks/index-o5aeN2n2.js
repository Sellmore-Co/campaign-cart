import { c as createLogger, L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as configStore, t as testModeManager, f as LogLevel } from "./utils-65_XgUQi.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-65_XgUQi.js").then((n) => n.s);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-65_XgUQi.js").then((n) => n.s);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BjwcGvOv.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CkoKNsgC.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-lVPvB7Uk.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CH11qHMi.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-Dzky4XwK.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-h77bpI51.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DzNp81vH.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Bb3-rmli.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CnnsFF4A.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CoRB-fPL.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-uzHxrF9Q.js");
        ...
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-C0prYFiJ.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CPvMFDAt.js");
        ...
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-C1w53ulZ.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BbvCtTNV.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CTfa5s8M.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-D9HCFiHb.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-65_XgUQi.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-65_XgUQi.js").then((n) => n.v).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-65_XgUQi.js").then((n) => n.w);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-65_XgUQi.js").then((n) => n.w).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-lVPvB7Uk.js");
        import("./CartToggleEnhancer-Dzky4XwK.js");
        import("./PackageSelectorEnhancer-DzNp81vH.js");
        import("./ProductDisplayEnhancer-wMLQ5_PP.js");
        import("./SelectionDisplayEnhancer-CH11qHMi.js");
      ...
      requestIdleCallback(() => {
        ...
        import("./OrderDisplayEnhancer-Bdn8xjHK.js");
        import("./UpsellEnhancer-CPvMFDAt.js");
        import("./utils-65_XgUQi.js").then((n) => n.A);
        import("./CartItemListEnhancer-CoRB-fPL.js");
        import("./QuantityControlEnhancer-DvNp6OY1.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-C1w53ulZ.js");
        import("./CouponEnhancer-Bz2USD2p.js");
        import("./SimpleExitIntentEnhancer-BjwcGvOv.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-lVPvB7Uk.js");
