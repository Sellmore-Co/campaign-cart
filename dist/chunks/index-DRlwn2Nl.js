...
import { ApiClient } from "./api-Ds2lLcpC.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-f7wcmG0D.js").then((n) => n.a0);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-f7wcmG0D.js").then((n) => n.a0);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Bn-KgF92.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-F39xMmvY.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-6oYF6sqK.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BeAJ-H7N.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-D5FvwIBc.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CJYgrq1C.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-oQGKnpko.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BywpAfV-.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-Bz1ftWzA.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-fOdd-k4l.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BeKyrpNU.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-Dty-1qz2.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CGmhDsRW.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-Bz4g8S0Y.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CHBeA-LS.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BZ_hbWtv.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DZkw_LsR.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-WLLLbihS.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-CpO8bqa3.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CJQk6wya.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-4Ach-gVT.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-C_Vwq0mM.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-p5CWX-Cz.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-f7wcmG0D.js").then((n) => n.Z);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-f7wcmG0D.js").then((n) => n.Z);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-f7wcmG0D.js").then((n) => n.a1);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-f7wcmG0D.js").then((n) => n.a2).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-f7wcmG0D.js").then((n) => n.a3);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-f7wcmG0D.js").then((n) => n.a3).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-6oYF6sqK.js");
        import("./CartToggleEnhancer-D5FvwIBc.js");
        import("./PackageSelectorEnhancer-BywpAfV-.js");
        import("./ProductDisplayEnhancer-Duo-L44q.js");
        import("./SelectionDisplayEnhancer-BeAJ-H7N.js");
        import("./TimerEnhancer-Bz1ftWzA.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BeKyrpNU.js");
        import("./ExpressCheckoutContainerEnhancer-CGmhDsRW.js");
        import("./OrderDisplayEnhancer-BPkCkWgb.js");
        import("./UpsellEnhancer-WLLLbihS.js");
        import("./utils-f7wcmG0D.js").then((n) => n.$);
        import("./CartItemListEnhancer-Bz4g8S0Y.js");
        import("./QuantityControlEnhancer-BZ_hbWtv.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CJQk6wya.js");
        import("./CouponEnhancer-CpO8bqa3.js");
        import("./SimpleExitIntentEnhancer-Bn-KgF92.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-6oYF6sqK.js");
        import("./ProductDisplayEnhancer-Duo-L44q.js");
        import("./utils-f7wcmG0D.js").then((n) => n.a4);
      }, 1e3);
    }
  });
}
