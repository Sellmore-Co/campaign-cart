...
<<<<<<<< HEAD:dist/chunks/utils-DondkAMT.js
...
========
const logger$e = createLogger("CartStore");
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
...
========
            logger$e.debug(`Adding upsell item:`, {
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
...
========
        logger$e.debug("syncWithAPI not yet implemented");
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
      },
...
========
          logger$e.debug("Cart store rehydrated, recalculating totals...");
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
...
const campaignStoreInstance = create((set, get) => ({
  ...
  loadCampaign: async (apiKey) => {
    ...
    try {
      ...
      const now = Date.now();
      if (cachedData && cachedData.apiKey === apiKey && now - cachedData.timestamp < CACHE_EXPIRY_MS) {
        logger$d.info("🎯 Using cached campaign data (expires in " + Math.round((CACHE_EXPIRY_MS - (now - cachedData.timestamp)) / 1e3) + " seconds)");
      ...
      logger$d.info("🌐 Fetching fresh campaign data from API...");
      const { ApiClient } = await import("./api-CJA3TCCv.js");
      const client = new ApiClient(apiKey);
      ...
      logger$d.info("💾 Campaign data cached for 5 minutes");
      set({
        data: campaign,
        packages: campaign.packages,
        isLoading: false,
  ...
  clearCache: () => {
    sessionStorageManager.remove(CAMPAIGN_STORAGE_KEY);
    logger$d.info("🗑️ Campaign cache cleared");
  },
  getCacheInfo: () => {
    const cachedData = sessionStorageManager.get(CAMPAIGN_STORAGE_KEY);
    if (!cachedData) {
...
<<<<<<<< HEAD:dist/chunks/utils-DondkAMT.js
  ...
  analytics as N,
========
  trackCheckoutValidationFailed as A,
  trackCheckoutSubmitted as B,
  CART_STORAGE_KEY as C,
  userDataStorage as D,
  EventBus as E,
  FieldFinder as F,
  getPaymentCapabilities as G,
  isApplePayAvailable as H,
  isPayPalAvailable as I,
  isGooglePayAvailable as J,
  trackEmptyCartCheckoutAttempt as K,
  Logger as L,
  getFailureUrl as M,
  getSuccessUrl as N,
...
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
  ...
  DisplayValueValidator as R,
  cartStore as S,
  TemplateRenderer as T,
  AttributionCollector$1 as U,
  index as V,
  UtmTransfer$1 as W,
  errorHandler$1 as X,
  DebugOverlay$1 as Y,
...
========
  trackPageView as g,
  trackSDKInitialized as h,
  trackSDKInitializationFailed as i,
  trackCampaignLoaded as j,
  testModeManager as k,
  trackCartLoaded as l,
  LogLevel as m,
  ElementDataExtractor as n,
  PriceCalculator as o,
  nextAnalytics as p,
  EcommerceEvents as q,
  ErrorDisplayManager as r,
  EventHandlerManager as s,
  trackAPICall as t,
  useCartStore as u,
  CountryService as v,
  trackDuplicateOrderPrevention as w,
  trackCheckoutFailed as x,
  trackCheckoutCompleted as y,
  trackCheckoutStarted as z
>>>>>>>> origin/main:dist/chunks/utils-BzySd55V.js
};
