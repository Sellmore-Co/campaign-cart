import { n as nextAnalytics, l as EcommerceEvents, b as useAttributionStore, x as getFailureUrl, y as getSuccessUrl, z as handleOrderRedirect } from "./utils-vgQHeO41.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-vgQHeO41.js").then((n) => n.B);
