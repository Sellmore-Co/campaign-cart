import { n as nextAnalytics, j as EcommerceEvents, b as useAttributionStore, v as getFailureUrl, w as getSuccessUrl, x as handleOrderRedirect } from "./utils-CXZ9QiRP.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-CXZ9QiRP.js").then((n) => n.z);
