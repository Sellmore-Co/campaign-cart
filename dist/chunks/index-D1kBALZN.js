import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, g as useProfileStore, c as createLogger, h as trackPageView, i as trackSDKInitialized, j as trackSDKInitializationFailed, C as CountryService, k as trackCampaignLoaded, l as testModeManager, m as CART_STORAGE_KEY, n as trackCartLoaded, o as LogLevel } from "./utils-BvMFuFWj.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-BvMFuFWj.js").then((n) => n.$);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-BvMFuFWj.js").then((n) => n.$);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BGpzelAo.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BFfRq0pI.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BENcAj4S.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BRgEO1La.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-B0Fs6Lr_.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-zt1pwAtM.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-Bv4ALi-1.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-CE21aLWt.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-CJl2BVZJ.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-B32RCDsf.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BBdVCYr7.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DriGlLTg.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DeOWnh-r.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-C2VT4-Kg.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-_rNKHntZ.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BtPcQTCw.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-5D4YUYD6.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-CYrjABe7.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BqM2cEUl.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CtYCjrca.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CTxJbT72.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BWg5Lk-v.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BvMFuFWj.js").then((n) => n.a0);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BvMFuFWj.js").then((n) => n.a1).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-BvMFuFWj.js").then((n) => n.a2);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-BvMFuFWj.js").then((n) => n.a2).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BENcAj4S.js");
        import("./CartToggleEnhancer-B0Fs6Lr_.js");
        import("./PackageSelectorEnhancer-CE21aLWt.js");
        import("./ProductDisplayEnhancer-RJ2gGf9g.js");
        import("./SelectionDisplayEnhancer-BRgEO1La.js");
        import("./TimerEnhancer-CJl2BVZJ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BBdVCYr7.js");
        import("./ExpressCheckoutContainerEnhancer-DriGlLTg.js");
        import("./OrderDisplayEnhancer-C6ihC9md.js");
        import("./UpsellEnhancer-5D4YUYD6.js");
        import("./utils-BvMFuFWj.js").then((n) => n._);
        import("./CartItemListEnhancer-DeOWnh-r.js");
        import("./QuantityControlEnhancer-_rNKHntZ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BqM2cEUl.js");
        import("./CouponEnhancer-CYrjABe7.js");
        import("./SimpleExitIntentEnhancer-BGpzelAo.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-BENcAj4S.js");
        import("./ProductDisplayEnhancer-RJ2gGf9g.js");
        import("./utils-BvMFuFWj.js").then((n) => n.a3);
      }, 1e3);
    }
  });
}
