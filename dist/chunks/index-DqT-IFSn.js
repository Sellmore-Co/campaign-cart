import { c as createLogger, L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useCheckoutStore, d as configStore, t as testModeManager, e as LogLevel } from "./utils-Bgh0TU7j.js";
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-Bgh0TU7j.js").then((n) => n.A);
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-Bgh0TU7j.js").then((n) => n.m);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-Bgh0TU7j.js").then((n) => n.m);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-lm1uwCRs.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CHL4rZtH.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BDJUuf_p.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DscyPLyB.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CbV_so5z.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BN21pFH_.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CnmuRiNF.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-CjQzxnA5.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BSoIGCW1.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CV-XsKTl.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DbBT-Rad.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BFaBnET6.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BGB6P3yO.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-BghTHMAj.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-pI6-Zekz.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DPQEITen.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-BRbigYhb.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BfZR8hFI.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DJeqlXvr.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Bgay7qlg.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-9t8-Wgty.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DFu_ZSlC.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-Bgh0TU7j.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-Bgh0TU7j.js").then((n) => n.n).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-Bgh0TU7j.js").then((n) => n.o);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-Bgh0TU7j.js").then((n) => n.o).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BDJUuf_p.js");
        import("./CartToggleEnhancer-CbV_so5z.js");
        import("./PackageSelectorEnhancer-CjQzxnA5.js");
        import("./ProductDisplayEnhancer-DBdKkze4.js");
        import("./SelectionDisplayEnhancer-DscyPLyB.js");
        import("./TimerEnhancer-BSoIGCW1.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DbBT-Rad.js");
        import("./ExpressCheckoutContainerEnhancer-BFaBnET6.js");
        import("./OrderDisplayEnhancer-BepayW6R.js");
        import("./UpsellEnhancer-BRbigYhb.js");
        import("./utils-Bgh0TU7j.js").then((n) => n.A);
        import("./CartItemListEnhancer-BGB6P3yO.js");
        import("./QuantityControlEnhancer-pI6-Zekz.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DJeqlXvr.js");
        import("./CouponEnhancer-BfZR8hFI.js");
        import("./SimpleExitIntentEnhancer-lm1uwCRs.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-BDJUuf_p.js");
        import("./ProductDisplayEnhancer-DBdKkze4.js");
        import("./utils-Bgh0TU7j.js").then((n) => n.q);
      }, 1e3);
    }
  });
}
