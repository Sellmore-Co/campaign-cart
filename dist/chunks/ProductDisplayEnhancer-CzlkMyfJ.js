import { B as BaseDisplayEnhancer, a as getPropertyMapping, D as DisplayFormatter, P as PropertyResolver } from "./DisplayEnhancerCore-eGQ2kdz4.js";
import { A as AttributeParser } from "./index-vJoanOk4.js";
import { a as useCampaignStore, u as useCartStore, h as useProfileStore, i as PackageContextResolver, k as PriceCalculator } from "./utils-vgQHeO41.js";
...
class ProductDisplayEnhancer extends BaseDisplayEnhancer {
  ...
  loadPackageData() {
    ...
    this.originalPackageData = this.campaignState.packages?.find((pkg) => pkg.ref_id === this.packageId);
    ...
    this.packageData = this.campaignState.packages?.find((pkg) => pkg.ref_id === targetPackageId);
    ...
    if (!this.packageData) {
      ...
      const availableIds = this.campaignState.packages?.map((p) => p.ref_id).join(", ");
