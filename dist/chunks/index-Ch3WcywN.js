import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, C as CountryService, t as testModeManager, g as CART_STORAGE_KEY, h as LogLevel } from "./utils-CBsAJYAz.js";
import { ApiClient } from "./api-CMFTGFcZ.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-CBsAJYAz.js").then((n) => n.J);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-CBsAJYAz.js").then((n) => n.J);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CHGE8Kvp.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-mcA1anVA.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DN-4XebQ.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DHj7kykm.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BHHkAoFR.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CQ8XGFcg.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-C2Sn-q7p.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BSbRtyIZ.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-1_cUPIvk.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DmKVJqjX.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-C_Bji1Af.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-4gaeY-bY.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DXBAxVSr.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-ynH-8cnf.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-i4Dqu-cG.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-YVCbz8DF.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-B4YftRX7.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-B_hJXE2u.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DK-teEmy.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Bk5sP_Nj.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CgXpQpZF.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-HCz90Tsv.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CBsAJYAz.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CBsAJYAz.js").then((n) => n.K).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-CBsAJYAz.js").then((n) => n.M);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-CBsAJYAz.js").then((n) => n.M).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DN-4XebQ.js");
        import("./CartToggleEnhancer-BHHkAoFR.js");
        import("./PackageSelectorEnhancer-BSbRtyIZ.js");
        import("./ProductDisplayEnhancer-rhZh5zpa.js");
        import("./SelectionDisplayEnhancer-DHj7kykm.js");
        import("./TimerEnhancer-1_cUPIvk.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-C_Bji1Af.js");
        import("./ExpressCheckoutContainerEnhancer-4gaeY-bY.js");
        import("./OrderDisplayEnhancer-BHUJ6YRN.js");
        import("./UpsellEnhancer-B4YftRX7.js");
        import("./utils-CBsAJYAz.js").then((n) => n.I);
        import("./CartItemListEnhancer-DXBAxVSr.js");
        import("./QuantityControlEnhancer-i4Dqu-cG.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DK-teEmy.js");
        import("./CouponEnhancer-B_hJXE2u.js");
        import("./SimpleExitIntentEnhancer-CHGE8Kvp.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-DN-4XebQ.js");
        import("./ProductDisplayEnhancer-rhZh5zpa.js");
        import("./utils-CBsAJYAz.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
