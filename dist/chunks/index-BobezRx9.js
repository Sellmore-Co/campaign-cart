      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-Csau-wlN.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-Bxzp8sbE.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CGqaGmO6.js");
        ...
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-BgviPxgg.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-1tvnQl6O.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Be59pzqa.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-qUw-FfGn.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-BWVi3lsq.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-SvTseLNr.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-Csau-wlN.js");
        import("./CartToggleEnhancer-DvhD6Akm.js");
        import("./PackageSelectorEnhancer-B-XDsNLz.js");
        import("./ProductDisplayEnhancer-BrXeA_fD.js");
        import("./SelectionDisplayEnhancer-Bxzp8sbE.js");
        import("./TimerEnhancer-jgABMaL2.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-1tvnQl6O.js");
        import("./ExpressCheckoutContainerEnhancer-Be59pzqa.js");
        import("./OrderDisplayEnhancer-BkVlGOgW.js");
        import("./UpsellEnhancer-SvTseLNr.js");
        import("./utils-DBcBpo1g.js").then((n) => n.A);
        import("./CartItemListEnhancer-qUw-FfGn.js");
