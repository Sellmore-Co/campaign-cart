import { n as nextAnalytics, i as EcommerceEvents, b as useAttributionStore, m as getFailureUrl, o as getSuccessUrl, p as handleOrderRedirect } from "./utils-65_XgUQi.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore } = await import("./utils-65_XgUQi.js").then((n) => n.r);
