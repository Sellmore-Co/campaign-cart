import { L as Logger, E as EventBus, u as useCartStore, a as useCampaignStore, b as useAttributionStore, d as useCheckoutStore, e as useOrderStore, f as configStore, c as createLogger, C as CountryService, t as testModeManager, g as CART_STORAGE_KEY, h as LogLevel } from "./utils-Bnlf88EQ.js";
import { ApiClient } from "./api-BRscYlI6.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./utils-Bnlf88EQ.js").then((n) => n.J);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./utils-Bnlf88EQ.js").then((n) => n.J);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DGF68jqC.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BqeDpfHJ.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-B-cYhxcN.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-nXH85nFY.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-DD2nmZpv.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BnylfOdo.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-iBWn63n4.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-kkaiICZx.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BV_yp4Nd.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CAGFP__2.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-B_c-gfkt.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Q1jgcD2l.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-mEOcQSkS.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CCljFQHd.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-Bbemm8ft.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DeFAgONe.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CXcBmNUB.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DhUu4T6E.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-D2Gi5Mjm.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BTebkZHj.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-Bnlf88EQ.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-Bnlf88EQ.js").then((n) => n.K).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./utils-Bnlf88EQ.js").then((n) => n.M);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./utils-Bnlf88EQ.js").then((n) => n.M).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-B-cYhxcN.js");
        import("./CartToggleEnhancer-DD2nmZpv.js");
        import("./PackageSelectorEnhancer-kkaiICZx.js");
        import("./ProductDisplayEnhancer-BlWnlUEC.js");
        import("./SelectionDisplayEnhancer-nXH85nFY.js");
        import("./TimerEnhancer-BV_yp4Nd.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-B_c-gfkt.js");
        import("./ExpressCheckoutContainerEnhancer-Q1jgcD2l.js");
        import("./OrderDisplayEnhancer-CMyWhR8a.js");
        import("./UpsellEnhancer-Bbemm8ft.js");
        import("./utils-Bnlf88EQ.js").then((n) => n.I);
        import("./CartItemListEnhancer-mEOcQSkS.js");
        import("./QuantityControlEnhancer-D8wUtx8-.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CXcBmNUB.js");
        import("./CouponEnhancer-DeFAgONe.js");
        import("./SimpleExitIntentEnhancer-DGF68jqC.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./CartDisplayEnhancer-B-cYhxcN.js");
        import("./ProductDisplayEnhancer-BlWnlUEC.js");
        import("./utils-Bnlf88EQ.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
