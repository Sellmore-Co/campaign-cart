import { B as BaseActionEnhancer } from "./BaseActionEnhancer-4vndGEeU.js";
import { u as useCartStore, A as preserveQueryParams } from "./utils-vgQHeO41.js";
class AddToCartEnhancer extends BaseActionEnhancer {
  ...
  async handleClick(event) {
    ...
    if (profileOverride) {
      const { ProfileManager } = await import("./index-vJoanOk4.js").then((n) => n.c);
