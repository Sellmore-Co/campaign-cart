...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./index-CX_Xeuri.js");
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./index-CX_Xeuri.js");
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BY0pKZ7A.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DjsZfp_o.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CVDWtMY7.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-EjVJEnuL.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-NURlbQaV.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-Dz0nyrhi.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-BkXopCG6.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BAZc0-NN.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DrIpragd.js");
          return new TimerEnhancer(element);
        case "conditional":
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-xM5RIjTn.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BSpMNrw_.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DRP2rq5T.js");
          return new ExpressCheckoutContainerEnhancer(element);
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BZB3V0Sq.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-GxR60PF2.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-ClcxPDjC.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BY4EXtpm.js");
          return new RemoveItemEnhancer(element);
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CHkIjNLK.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BAalXKmJ.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Dr_HfDq4.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-B-YGeJqi.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static initializeErrorHandler() {
    try {
      import("./errorHandler-dh5ptpOw.js").then(({ errorHandler }) => {
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CVDWtMY7.js");
        import("./CartToggleEnhancer-NURlbQaV.js");
        import("./PackageSelectorEnhancer-BAZc0-NN.js");
        import("./ProductDisplayEnhancer-BAmEMSV1.js");
        import("./SelectionDisplayEnhancer-EjVJEnuL.js");
        import("./TimerEnhancer-DrIpragd.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BSpMNrw_.js");
        import("./ExpressCheckoutContainerEnhancer-DRP2rq5T.js");
        import("./OrderDisplayEnhancer-D5cCsaLm.js");
        import("./UpsellEnhancer-CHkIjNLK.js");
        import("./AttributionCollector-C2WwjCQi.js");
        import("./CartItemListEnhancer-BZB3V0Sq.js");
        import("./QuantityControlEnhancer-ClcxPDjC.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Dr_HfDq4.js");
        import("./CouponEnhancer-BAalXKmJ.js");
        import("./SimpleExitIntentEnhancer-BY0pKZ7A.js");
