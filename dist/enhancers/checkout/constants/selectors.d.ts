...
export declare const META_TAG_SELECTORS: {
    readonly SUCCESS_URL: readonly ["meta[name=\"next-success-url\"]", "meta[name=\"os-next-page\"]"];
    readonly FAILURE_URL: readonly ["meta[name=\"next-failure-url\"]", "meta[name=\"os-failure-url\"]"];
    readonly NEXT_PAGE: readonly ["meta[name=\"next-next-url\"]", "meta[name=\"os-next-page\"]"];
};
