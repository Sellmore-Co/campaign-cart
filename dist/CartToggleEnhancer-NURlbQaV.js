...
import { u as useCartStore, a as useCampaignStore } from "./analytics-Dvf5RBLE.js";
class CartToggleEnhancer extends BaseEnhancer {
  ...
  detectUpsellContext() {
    this.isUpsell = this.getAttribute("data-next-is-upsell") === "true" || this.stateContainer?.hasAttribute("data-next-upsell") === true || this.stateContainer?.hasAttribute("data-next-bump") === true || this.element.closest("[data-next-upsell-section]") !== null || this.element.closest("[data-next-bump-section]") !== null;
  }
  async checkAutoAdd() {
