...
var TwentyNineNext = (() => {
  ...
  var AddressHandler = class {
    constructor(form, logger) {
       ...
       */
      __privateAdd(this, _updateGlobalLocalizationData);
      /**
       ...
       */
      __privateAdd(this, _triggerLocalizationUpdateEvent);
  ...
  init_fn = async function() {
    ...
    window.osAddressHandlerReady = true;
  };
  ...
  loadCountriesAndInitialState_fn = async function() {
    ...
    if (!localizationData) {
      __privateGet(this, _logger2).error("No global localization data available! TwentyNineNext should have loaded this first.");
      await __privateMethod(this, _loadCountriesAndStatesFallback, loadCountriesAndStatesFallback_fn).call(this);
      return;
    }
    __privateGet(this, _logger2).info("Using globally cached localization data from TwentyNineNext");
    try {
      if (localizationData.countries && Array.isArray(localizationData.countries)) {
        __privateSet(this, _countries, localizationData.countries.filter((country) => {
        ...
        __privateGet(this, _logger2).info(`Loaded ${__privateGet(this, _countries).length} countries from global cache`);
      }
      const forcedCountry = __privateMethod(this, _checkForForcedCountry, checkForForcedCountry_fn).call(this);
      ...
      if (forcedCountry) {
        ...
        if (countryExists) {
          ...
          __privateGet(this, _logger2).info(`🔧 Forced country override: ${forcedCountry} (detected: ${localizationData.detectedCountryCode})`);
      ...
      __privateGet(this, _logger2).error("Error processing global localization data:", error);
      await __privateMethod(this, _loadCountriesAndStatesFallback, loadCountriesAndStatesFallback_fn).call(this);
    }
  };
  ...
  _updateGlobalLocalizationData = new WeakSet();
  updateGlobalLocalizationData_fn = function(countryCode, countryConfig) {
    try {
      if (window.osLocalizationData) {
        ...
        window.osLocalizationData.detectedCountryConfig = {
          ...
          ...countryConfig
          // Spread the rest of the new countryConfig
        };
  ...
  _triggerLocalizationUpdateEvent = new WeakSet();
  triggerLocalizationUpdateEvent_fn = function(countryCode, countryConfig) {
    try {
      ...
      __privateGet(this, _logger2).debug(`🔔 Triggered localization update event for ${countryCode}`);
    } catch (error) {
      __privateGet(this, _logger2).error("Error triggering localization update event:", error);
    }
  };
  ...
  var _app6, _logger11, _container2, _shippingMethods, _findShippingMethods, findShippingMethods_fn, _init6, init_fn6, _handleShippingChange, handleShippingChange_fn, _syncWithCartState, syncWithCartState_fn;
  ...
  init_fn6 = function() {
    ...
    __privateGet(this, _app6).state.subscribe("cart.shippingMethod", () => __privateMethod(this, _syncWithCartState, syncWithCartState_fn).call(this));
  ...
  handleShippingChange_fn = function(shippingMethodId) {
    ...
    try {
      __privateGet(this, _app6).cart.setShippingMethod(shippingMethodId);
    } catch (error) {
  ...
  syncWithCartState_fn = function() {
    const currentShippingMethod = __privateGet(this, _app6).state.getState("cart.shippingMethod");
  ...
  initBillingAddressHandler_fn = function() {
    try {
      this.billingAddressHandler = new BillingAddressHandler(__privateGet(this, _app7));
  ...
  initPaymentHandler_fn = function() {
    try {
      this.paymentHandler = new PaymentHandler(__privateGet(this, _apiClient2), __privateGet(this, _logger12), __privateGet(this, _app7));
    } catch (error) {
  ...
  initShippingSelector_fn = function() {
    try {
      this.shippingSelector = new ShippingSelector(__privateGet(this, _app7));
    } catch (error) {
  ...
  initProspectCartHandler_fn = function() {
    try {
      if (__privateGet(this, _app7)) {
        this.prospectCartHandler = new ProspectCartHandler(__privateGet(this, _app7));
  ...
  setupEventListeners_fn3 = function() {
    try {
      ...
      if (__privateGet(this, _app7) && __privateGet(this, _app7).events && this.prospectCartHandler) {
        __privateGet(this, _app7).events.on("prospect.cartCreated", (data) => {
          __privateGet(this, _logger12).info("Prospect cart created successfully", data);
        });
      }
      if (__privateGet(this, _app7) && __privateGet(this, _app7).events) {
        __privateGet(this, _app7).events.on("order.created", (data) => {
  ...
  var _app8, _logger13, _viewItemListFired;
  var CampaignHelper = class {
    ...
    getCampaignData() {
      const campaignData = __privateGet(this, _app8).campaignData;
      return campaignData;
    }
    getCampaignName() {
      return __privateGet(this, _app8).campaignData?.name ?? "";
    }
    getCampaignId() {
      return __privateGet(this, _app8).campaignData?.id ?? "";
    }
    getProducts() {
      const products = __privateGet(this, _app8).campaignData?.products ?? [];
      return products;
    }
    ...
    getCurrency() {
      return __privateGet(this, _app8).campaignData?.currency ?? "USD";
    }
    getLocale() {
      return __privateGet(this, _app8).campaignData?.locale ?? "en-US";
    }
    formatPrice(price) {
     ...
     */
    triggerViewItemList() {
      if (!__privateGet(this, _app8).campaignData) {
        __privateGet(this, _logger13).warn("Cannot trigger view_item_list: No campaign data available");
        return;
      }
      if (!__privateGet(this, _app8).eventManager) {
        __privateGet(this, _logger13).warn("Cannot trigger view_item_list: EventManager not found");
        return;
      }
      if (typeof __privateGet(this, _app8).eventManager.viewVisibleItemList === "function") {
        __privateGet(this, _logger13).debug("Manually triggering viewVisibleItemList event");
        __privateGet(this, _app8).eventManager.viewVisibleItemList();
      } else if (__privateGet(this, _app8).events?.viewItemList) {
        __privateGet(this, _logger13).debug("Falling back to events.viewItemList method");
        __privateGet(this, _app8).events.viewItemList(__privateGet(this, _app8).campaignData);
      } else {
  ...
  var StateManager = class {
    ...
    async syncCartWithApi() {
      try {
        ...
        const response = await __privateGet(this, _app9).api.createCart(apiCart);
        __privateGet(this, _logger14).info("Cart synced with API");
        __privateGet(this, _app9).triggerEvent("cart.synced", { cart: response });
        return response;
      } catch (error) {
  ...
  processCartUpdates_fn = function(notify = true, changedPath = "cart") {
    ...
    if (!__privateGet(this, _app9).discount) {
  ...
  var _app10, _stateManager, _logger15, _cartElements, _initCartUI, initCartUI_fn, _updateCartUI, updateCartUI_fn, _createCartItemElement, createCartItemElement_fn, _addToCart, addToCart_fn, _updateCartItemQuantity, updateCartItemQuantity_fn, _removeFromCart, removeFromCart_fn;
  ...
  updateCartUI_fn = function() {
    ...
    if (couponElement && couponContainer) {
      if (cart.couponDetails && cart.couponCode) {
        couponElement.textContent = __privateGet(this, _app10).discount?.getCouponDisplayText(cart.couponDetails) || cart.couponCode;
  ...
  var SelectorManager = class {
     ...
     */
    triggerViewItemList() {
      const campaignData = __privateGet(this, _app11).getCampaignData();
      ...
      if (visiblePackages.length > 0) {
        ...
        if (__privateGet(this, _app11).eventManager?.viewItemList) {
          __privateGet(this, _app11).eventManager.viewItemList(filteredCampaignData);
          __privateGet(this, _logger16).debug("Used eventManager.viewItemList to fire event");
        } else if (__privateGet(this, _app11).events?.viewItemList) {
          __privateGet(this, _app11).events.viewItemList(filteredCampaignData);
  ...
  handleClick_fn = function(selectorId, item) {
    ...
    if (item.shippingId !== null && item.shippingId !== void 0) {
      ...
      try {
        __privateGet(this, _app11).cart.setShippingMethod(item.shippingId);
      } catch (error) {
  ...
  updateCart_fn = function(selectorId, previousItem) {
    ...
    if (!__privateGet(this, _app11).cart.isItemInCart(selected.packageId)) {
    ...
    if (currentSelectedItem && currentSelectedItem.shippingId !== null && currentSelectedItem.shippingId !== void 0) {
      const currentCartShippingMethod = __privateGet(this, _app11).state?.getState("cart")?.shippingMethod?.ref_id;
      if (currentCartShippingMethod?.toString() !== currentSelectedItem.shippingId.toString()) {
        ...
        try {
          __privateGet(this, _app11).cart.setShippingMethod(currentSelectedItem.shippingId);
        } catch (error) {
  ...
  addItemToCart_fn = function(item) {
    ...
    if (typeof __privateGet(this, _app11).cart.addToCart !== "function") {
      __privateGet(this, _logger16).error("addToCart is not a function on this.#app.cart:", __privateGet(this, _app11).cart);
      return;
    }
    __privateGet(this, _logger16).info(`Adding item ${item.packageId} to cart`);
    __privateGet(this, _app11).cart.addToCart({
      id: item.packageId,
      name: item.name,
      price: item.price,
  ...
  removeItemFromCart_fn = function(item) {
    ...
    if (typeof __privateGet(this, _app11).cart.removeFromCart !== "function") {
      __privateGet(this, _logger16).error("removeFromCart is not a function on this.#app.cart:", __privateGet(this, _app11).cart);
      return;
    }
    __privateGet(this, _logger16).info(`Removing item ${item.packageId} from cart`);
    __privateGet(this, _app11).cart.removeFromCart(item.packageId);
  ...
  syncWithCart_fn = function() {
    ...
    __privateGet(this, _logger16).debug("Syncing with cart, this.#app.cart:", __privateGet(this, _app11).cart);
    Object.keys(__privateGet(this, _selectors2)).forEach((selectorId) => {
      const items = __privateGet(this, _selectors2)[selectorId].items;
      const cartItemsInSelector = items.filter((item) => __privateGet(this, _app11).cart.isItemInCart(item.packageId));
      ...
      items.forEach((item) => {
        const isInCart = __privateGet(this, _app11).cart.isItemInCart(item.packageId);
  ...
  updateUnitPricingForCard_fn = function(item, packages) {
    ...
    const couponDetails = __privateGet(this, _app11).cart?.getCouponDetails?.();
  ...
  getPackageDataFromCampaign_fn = function(packageId) {
    if (!__privateGet(this, _app12).campaignData?.packages) {
  ...
  init_fn7 = function() {
    ...
    __privateGet(this, _app13).state?.subscribe("cart", () => {
  ...
  var _app14, _logger19, _timers, _storagePrefix, _initTimers, initTimers_fn, _setupTimer, setupTimer_fn, _getTimerConfig, getTimerConfig_fn, _formatTime, formatTime_fn, _triggerTimerEvent, triggerTimerEvent_fn;
  ...
  var _app15, _logger20, _displayElements, _priceElements, _setupCountryChangeListener5, setupCountryChangeListener_fn5, _setupCurrencyChangeListener, setupCurrencyChangeListener_fn, _initDisplayElements, initDisplayElements_fn, _updateContainerDisplay, updateContainerDisplay_fn, _triggerDisplayEvent, triggerDisplayEvent_fn, _initPriceElements, initPriceElements_fn, _updatePackagePricing, updatePackagePricing_fn, _updateProfilePricing, updateProfilePricing_fn, _translatePackageId2, translatePackageId_fn2, _getPackageData, getPackageData_fn, _calculatePackagePricing, calculatePackagePricing_fn, _getPriceValue, getPriceValue_fn, _formatPriceValue, formatPriceValue_fn, _getCurrencySymbol, getCurrencySymbol_fn;
  var DisplayManager = class {
    ...
    constructor(app) {
      ...
      __privateMethod(this, _setupCurrencyChangeListener, setupCurrencyChangeListener_fn).call(this);
    ...
    refreshPackagePricing() {
      ...
      __privateGet(this, _priceElements).forEach((elements, elementId) => {
        ...
        if (isProfile) {
          __privateMethod(this, _updateProfilePricing, updateProfilePricing_fn).call(this, elementId, elements);
        } else {
          __privateMethod(this, _updatePackagePricing, updatePackagePricing_fn).call(this, elementId, elements);
        }
      });
    }
    /**
  ...
  updatePackagePricing_fn = function(packageId, elements) {
    ...
    elements.forEach(({ element, priceType, divideBy, format, hideIfZero, showDecimals }) => {
      ...
      const displayValue = __privateMethod(this, _formatPriceValue, formatPriceValue_fn).call(this, value, priceType, format, showDecimals);
  ...
  updateProfilePricing_fn = function(profileId, elements) {
  ...
  formatPriceValue_fn = function(value, priceType, format, showDecimals = false) {
    ...
    if (value <= 0)
      return "";
    return __privateGet(this, _app15).currency.formatPrice(value, null, false, { showDecimals });
  };
  ...
  var CartDisplayManager = class {
    constructor(app) {
       ...
       */
      __privateAdd(this, _updateCurrencySymbols);
  ...
  _updateCurrencySymbols = new WeakSet();
  updateCurrencySymbols_fn = function() {
  ...
  var AttributionManager = class {
    ...
    updateAttributionData(newData) {
      ...
      if (__privateGet(this, _app17).events) {
        __privateGet(this, _app17).events.trigger("attribution.updated", {
    ...
    debug() {
      ...
      const campaignName = __privateGet(this, _app17).campaign?.getCampaignName() || __privateGet(this, _app17).campaignData?.name || "";
      ...
      /* @__PURE__ */ console.log("Campaign Name:", __privateGet(this, _app17).campaignData?.name || "Not available");
      if (__privateGet(this, _app17).state) {
        /* @__PURE__ */ console.log("API-formatted State Attribution:", __privateGet(this, _app17).state.getState("attribution"));
      }
      console.groupEnd();
  ...
  storeAttributionData_fn = function() {
    ...
    __privateGet(this, _app17).state.setState("cart.attribution", __privateGet(this, _attributionData));
    __privateGet(this, _app17).state.setState("attribution", this.getAttributionForApi());
  ...
  setupEventListeners_fn4 = function() {
    ...
    if (__privateGet(this, _app17).events) {
      __privateGet(this, _app17).events.on("campaign.loaded", (data) => {
      ...
      __privateGet(this, _app17).events.on("prospect.cartCreated", () => {
        const metadata = __privateGet(this, _attributionData).metadata || {};
  ...
  var EventManager = class {
    ...
    addToCart(cartData) {
      ...
      if (isSinglePackage) {
        ...
        const item = {
          ...
          currency: pkg.currency || __privateGet(this, _app18).getCampaignData()?.currency || "USD",
    ...
    viewItem(packageData) {
      ...
      const item = {
        ...
        currency: packageData.currency || __privateGet(this, _app18).getCampaignData()?.currency || "USD",
        quantity: 1
      };
      const eventData = {
        event: "view_item",
     ...
     */
    beginCheckout() {
      const cart = __privateGet(this, _app18).state.getState("cart");
      if (!cart || !cart.items || cart.items.length === 0) {
  ...
  setupEventListeners_fn5 = function() {
    ...
    __privateGet(this, _app18).on("order.loaded", (data) => {
  ...
  var _app19, _logger24, _tooltip, _arrowElement, _textContainer, _currentElement, _showTimeout, _hideTimeout, _initialized3, _init9, init_fn9, _createTooltip, createTooltip_fn, _setupEventListeners6, setupEventListeners_fn6, _showTooltip, showTooltip_fn, _hideTooltip, hideTooltip_fn;
  ...
  var CountryCampaignManager = class {
     ...
     */
    forceUnlockCountry() {
      __privateGet(this, _logger27).warn("Force unlock country called (deprecated - country locking removed)");
  ...
  detectUserCountry_fn = async function() {
    ...
    if (forceCountry) {
      ...
      __privateGet(this, _logger27).info(`🔧 Using forced country from URL: ${forcedCountry}`);
  ...
  var ProductProfileManager = class {
    ...
    getFormattedPrice(profileId, priceType = "total-sale", options = {}) {
      ...
      if (price === null)
        return "";
      return __privateGet(this, _app23).currency.formatPrice(price, null, false, options);
    }
    /**
  ...
  var CurrencyService = class {
    constructor(app) {
      ...
      __privateAdd(this, _CURRENCY_WORKER_URL, "https://cdn-countries.muddy-wind-c7ca.workers.dev");
      ...
      __privateGet(this, _logger29).infoWithTime("CurrencyService initialized with multi-currency support");
    }
    /**
    ...
    getCurrencyCode() {
      ...
      let currency, source;
      if (__privateGet(this, _logger29).isDebugEnabled) {
        __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] getCurrencyCode() - Starting currency detection...`);
      }
      const currentLocalizationData = window.osLocalizationData || __privateGet(this, _app24).getLocalizationData();
      const localizationCurrency = currentLocalizationData?.detectedCountryConfig?.currencyCode;
      const detectedCountry = currentLocalizationData?.detectedCountryCode;
      if (__privateGet(this, _logger29).isDebugEnabled) {
        __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] Localization - Country: "${detectedCountry}", Currency: "${localizationCurrency}"`);
        if (detectedCountry && detectedCountry !== "CA") {
          const urlParams = new URLSearchParams(window.location.search);
          const forcedCountry = urlParams.get("forceCountry");
          if (forcedCountry) {
            __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] ⚠️ STALE DATA: forceCountry=${forcedCountry} but localization shows ${detectedCountry}`);
          }
        }
      }
      ...
      if (!currency && __privateGet(this, _app24).countryCampaign && __privateGet(this, _app24).countryCampaign.isInitialized) {
        const currentCountry = __privateGet(this, _app24).countryCampaign.getCurrentCountry();
        const currentCampaignData = __privateGet(this, _app24).countryCampaign.getCurrentCampaignData();
        if (__privateGet(this, _logger29).isDebugEnabled) {
          __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] CountryCampaign - Country: "${currentCountry}", Campaign Currency: "${currentCampaignData?.currency}"`);
        }
        const baseCampaignData = __privateGet(this, _app24).getCampaignData();
        if (currentCountry && currentCampaignData?.currency && currentCampaignData.currency !== baseCampaignData?.currency) {
          currency = currentCampaignData.currency;
          source = `country campaign manager (${currentCountry})`;
        }
      } else if (!currency && __privateGet(this, _logger29).isDebugEnabled) {
        __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] CountryCampaign not available or not initialized`);
      }
      if (!currency) {
        const campaignData = __privateGet(this, _app24).getCampaignData();
        if (__privateGet(this, _logger29).isDebugEnabled) {
          __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] Campaign fallback - Currency: "${campaignData?.currency}"`);
        }
      ...
      __privateMethod(this, _updateCacheValidation, updateCacheValidation_fn).call(this);
      __privateGet(this, _logger29).infoWithTime(`💱 [CurrencyService] getCurrencyCode() → "${currency}" (from ${source})`);
      return currency;
    }
    /**
    ...
    formatPrice(price, currencyCode = null, skipConversion = false) {
      ...
      __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] formatPrice(${price}, ${currencyCode || "auto"}) → "${formatted}" ${!skipConversion && targetCurrency !== baseCurrency ? `(converted from ${baseCurrency})` : ""}`);
      return formatted;
    }
    /**
    ...
    convertPrice(amount, fromCurrency, toCurrency) {
      if (typeof amount !== "number" || isNaN(amount)) {
        __privateGet(this, _logger29).warnWithTime(`Invalid amount for conversion: ${amount}`);
        return 0;
      }
      ...
      try {
        const exchangeRate = __privateMethod(this, _getExchangeRate, getExchangeRate_fn).call(this, fromCurrency, toCurrency);
        const convertedAmount = amount * exchangeRate;
        __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] convertPrice(${amount} ${fromCurrency} → ${toCurrency}) = ${convertedAmount.toFixed(2)} (rate: ${exchangeRate})`);
        return convertedAmount;
      } catch (error) {
        __privateGet(this, _logger29).error(`Failed to convert ${amount} from ${fromCurrency} to ${toCurrency}:`, error);
        return amount;
      }
    }
    /**
    ...
    async initializeExchangeRates() {
      try {
        ...
        __privateGet(this, _logger29).error("💱 [CurrencyService] Failed to initialize exchange rates:", error);
        return false;
      }
    }
    /**
    ...
    getCacheStatus() {
      return {
        ...
        exchangeRatesCached: __privateGet(this, _cache).exchangeRates.size,
        exchangeRatesAge: __privateGet(this, _cache).exchangeRatesTimestamp ? Date.now() - __privateGet(this, _cache).exchangeRatesTimestamp : null,
        exchangeRatesValid: __privateMethod(this, _isExchangeRateCacheValid, isExchangeRateCacheValid_fn).call(this),
  ...
  getExchangeRate_fn = function(fromCurrency, toCurrency) {
    const rateKey = `${fromCurrency}_${toCurrency}`;
    if (__privateGet(this, _cache).exchangeRates.has(rateKey) && __privateMethod(this, _isExchangeRateCacheValid, isExchangeRateCacheValid_fn).call(this)) {
      return __privateGet(this, _cache).exchangeRates.get(rateKey);
    }
    __privateMethod(this, _fetchExchangeRates, fetchExchangeRates_fn).call(this);
    __privateGet(this, _logger29).debugWithTime(`💱 [CurrencyService] Exchange rate not available for ${rateKey}, using fallback rate of 1`);
    return 1;
  };
  _fetchExchangeRates = new WeakSet();
  fetchExchangeRates_fn = async function() {
    try {
      if (__privateMethod(this, _isExchangeRateCacheValid, isExchangeRateCacheValid_fn).call(this) && __privateGet(this, _cache).exchangeRates.size > 0) {
        __privateGet(this, _logger29).debugWithTime("💱 [CurrencyService] Using cached exchange rates");
        return __privateMethod(this, _getCachedExchangeRates, getCachedExchangeRates_fn).call(this);
      }
      __privateGet(this, _logger29).info("💱 [CurrencyService] Fetching fresh exchange rates from worker...");
      const response = await fetch(`${__privateGet(this, _CURRENCY_WORKER_URL)}/currencies/rates`);
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
      if (data.rates) {
        ...
        __privateMethod(this, _cacheExchangeRates, cacheExchangeRates_fn).call(this, exchangeRates);
        __privateGet(this, _logger29).info(`💱 [CurrencyService] Exchange rates cached: ${Object.keys(exchangeRates).length} rates`);
        return exchangeRates;
      } else {
        throw new Error("No rates in response");
      }
    } catch (error) {
      __privateGet(this, _logger29).error("💱 [CurrencyService] Failed to fetch exchange rates:", error);
      if (__privateGet(this, _cache).exchangeRates.size > 0) {
        __privateGet(this, _logger29).warn("💱 [CurrencyService] Using expired cached exchange rates");
        return __privateMethod(this, _getCachedExchangeRates, getCachedExchangeRates_fn).call(this);
      }
      return {};
    }
  };
  _cacheExchangeRates = new WeakSet();
  cacheExchangeRates_fn = function(exchangeRates) {
    __privateGet(this, _cache).exchangeRates.clear();
    __privateGet(this, _cache).exchangeRatesTimestamp = Date.now();
    Object.entries(exchangeRates).forEach(([currencyPair, rate]) => {
      __privateGet(this, _cache).exchangeRates.set(currencyPair, rate);
    });
  };
  _getCachedExchangeRates = new WeakSet();
  getCachedExchangeRates_fn = function() {
    const rates = {};
    __privateGet(this, _cache).exchangeRates.forEach((rate, pair) => {
      rates[pair] = rate;
    });
    return rates;
  };
  _isExchangeRateCacheValid = new WeakSet();
  isExchangeRateCacheValid_fn = function() {
    if (!__privateGet(this, _cache).exchangeRatesTimestamp) {
      return false;
    }
    const age = Date.now() - __privateGet(this, _cache).exchangeRatesTimestamp;
    return age < __privateGet(this, _EXCHANGE_RATES_TTL);
  };
  ...
  var TwentyNineNext = class {
    constructor(options = {}) {
       ...
       */
      __privateAdd(this, _loadLocalizationData);
      /**
       * Get cached localization data if valid
       */
      __privateAdd(this, _getLocalizationCache);
      /**
       ...
       */
      __privateAdd(this, _initializeExchangeRates);
      /**
      ...
      __privateAdd(this, _localizationData, null);
    ...
    async init() {
      ...
      await __privateMethod(this, _initializeExchangeRates, initializeExchangeRates_fn).call(this);
     ...
     */
    debugCurrency() {
      /* @__PURE__ */ console.log("🔧 [DEBUG] Testing CurrencyService...");
      /* @__PURE__ */ console.log("🔧 Currency Service exists:", !!this.currency);
      /* @__PURE__ */ console.log("🔧 Current Currency Code:", this.currency?.getCurrencyCode());
      /* @__PURE__ */ console.log("🔧 Base Currency Code:", this.currency?.getBaseCurrencyCode());
      /* @__PURE__ */ console.log("🔧 Currency Symbol:", this.currency?.getCurrencySymbol());
      /* @__PURE__ */ console.log("🔧 Cache Status:", this.currency?.getCacheStatus?.());
      /* @__PURE__ */ console.log("🔧 Localization Data:", window.osLocalizationData);
      /* @__PURE__ */ console.log("🔧 Country Campaign Manager:", this.countryCampaign?.getCurrentCountry());
      /* @__PURE__ */ console.log("🔧 Country Locked (deprecated):", false);
      /* @__PURE__ */ console.log("🔧 Detection Source:", this.countryCampaign?.getDetectionSource());
      return {
  ...
  _loadLocalizationData = new WeakSet();
  loadLocalizationData_fn = async function() {
    ...
    try {
      ...
      const data = await response.json();
      __privateSet(this, _localizationData, {
      ...
      __privateMethod(this, _saveLocalizationCache, saveLocalizationCache_fn).call(this, __privateGet(this, _localizationData));
      window.osLocalizationData = __privateGet(this, _localizationData);
  ...
  _getLocalizationCache = new WeakSet();
  getLocalizationCache_fn = function() {
    try {
      const cached = localStorage.getItem("os_localization_cache");
      if (cached) {
        const data = JSON.parse(cached);
        const hoursSinceCached = (Date.now() - data.timestamp) / (1e3 * 60 * 60);
  ...
  _saveLocalizationCache = new WeakSet();
  saveLocalizationCache_fn = function(data) {
    try {
